      ...
      {authMode === 'login' ? (
        <>
          ...
          <div className="mt-4 space-y-4 w-full">
            ...
            <button 
              onClick={() => window.location.href = 'https://api.fixieeasymanualonline.tech/oauth2/authorization/google'} 
            ...
            <button 
              onClick={() => window.location.href = 'https://api.fixieeasymanualonline.tech/oauth2/authorization/kakao'} 
